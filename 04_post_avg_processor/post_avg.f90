...
!     : Refer to the routine READINPUTFILE and post_inst.in file for detailed explanation
       ...
       INTEGER*8    :: IBMON,ITOT,IUVWP,IWXYZ,IALL,ISKIP,JSKIP,KSKIP,IHTRANS
...
!------VARIABLES
       INTEGER*8   :: IP(20),JP(20),KP(20)
       REAL*8      :: UAVG(M1M,M2M,M3M),VAVG(M1M,M2M,M3M),WAVG(M1M,M2M,M3M),UIUJAVG(M1M,M2M,M3M,6)
       REAL*8      :: PAVG(M1M,M2M,M3M),P2AVG(M1M,M2M,M3M),TAVG(M1M,M2M,M3M),T2AVG(M1M,M2M,M3M)
       REAL*8      :: VORAVG(M1M,M2M,M3M,3),VOR2AVG(M1M,M2M,M3M,6),SSAVG(M1M,M2M,M3M)
...
!=======================================================================
      ...
      OPEN(12,FILE='../output/field_avg/'//fileprevel,FORM='UNFORMATTED')
!     dum for future use
      READ(12)NN1,NN2,NN3,RRE
      READ(12)TIMEINIT,TIMEEND,IHISTINIT,IHISTEND
      READ(12)((( UAVG(I,J,K)     ,I=1,N1M),J=1,N2M),K=1,N3M)
      READ(12)((( VAVG(I,J,K)     ,I=1,N1M),J=1,N2M),K=1,N3M)
      READ(12)((( WAVG(I,J,K)     ,I=1,N1M),J=1,N2M),K=1,N3M)
      READ(12)((((UIUJAVG(I,J,K,L),I=1,N1M),J=1,N2M),K=1,N3M),L=1,6)
      READ(12)((( PAVG(I,J,K)     ,I=1,N1M),J=1,N2M),K=1,N3M)
      READ(12)((( P2AVG(I,J,K)    ,I=1,N1M),J=1,N2M),K=1,N3M)
      READ(12)((((VORAVG(I,J,K,L) ,I=1,N1M),J=1,N2M),K=1,N3M),L=1,3)
      READ(12)((((VOR2AVG(I,J,K,L)   ,I=1,N1M),J=1,N2M),K=1,N3M),L=1,6)
      READ(12)((( SSAVG(I,J,K)    ,I=1,N1M),J=1,N2M),K=1,N3M)
      IF (IHTRANS .EQ. 1) THEN
      READ(12)((( TAVG(I,J,K)    ,I=1,N1M),J=1,N2M),K=1,N3M)
      READ(12)((( T2AVG(I,J,K)    ,I=1,N1M),J=1,N2M),K=1,N3M)
      ENDIF
